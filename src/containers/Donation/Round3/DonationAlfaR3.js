...
/// For round 3 of experiment, links to qualtrics surve Alfa round 3 (redirects to post)
...
export default function DonationAlfaR3() {
                    ...
                    <Step key={label} {...stepProps}>
                        ...
                        <Typography gutterBottom variant="body1" color="text">{getStepContent(index)}</Typography>
                            <div className={classes.actionsContainer}>
                                ...
                                {activeStep === 4 && (
                                    <Button variant="contained" color="secondary" href="https://survey.uu.nl/jfe/form/SV_d4mu0UCmAlMqvBk" className={classes.button}>
