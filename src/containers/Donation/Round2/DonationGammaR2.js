...
/// For round 2 of experiment, links to qualtrics survey Gamma round 2
...
export default function DonationGammaR2() {
                        ...
                        <Typography gutterBottom variant="body1" color="text">{getStepContent(index)}</Typography>
                                <div className={classes.actionsContainer}>
                                    ...
                                    >
                                        ...
                                        {activeStep === 4 && (
                                            <Button variant="contained" color="secondary" href="https://survey.uu.nl/jfe/form/SV_71DoQ2ZDraW0wB0" className={classes.button}>
                                            {/* Final version survey Gamma round 2 */}
                                                Go to survey
                                            </Button>
                                        )}
                                    </Grid>
